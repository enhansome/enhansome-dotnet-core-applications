# Awesome collection of .NET Core realtime, sample, architecture reference application projects with stars
...
[**nopCommerce**](https://github.com/nopSolutions/nopCommerce) ⭐ 10,139 | 🐛 165 | 🌐 C# | 📅 2026-09-04 (**E-commerce**) (**GPLv3**) - is a popular open-source e-commerce shopping cart application.

[**OrchardCore**](https://github.com/OrchardCMS/OrchardCore) ⭐ 8,173 | 🐛 845 | 🌐 C# | 📅 2026-09-04 (**CMS**) (**BSD 3-Clause**) - is an open-source content management system (CMS) framework supporting modularity and multitenancy.
...
[**piranha.core**](https://github.com/piranhacms/piranha.core) ⭐ 2,192 | 🐛 100 | 🌐 C# | 📅 2026-08-09 (**CMS**) (**MIT**) - is a CMS application based on ASP.NET Core.

[**Blogifier**](https://github.com/blogifierdotnet/Blogifier) ⭐ 1,296 | 🐛 29 | 🌐 C# | 📅 2026-03-16 (**Blog engine**) (**MIT**) - is a lightweight blog engine written in ASP.NET Core.

[**Merp**](https://github.com/mastreeno/Merp) ⭐ 503 | 🐛 10 | 🌐 C# | 📅 2023-06-16 (**Merp**) (**AGPL-3.0**) - An event-based Micro ERP developed by Andrea Saltarello using ASP.NET Core 3.1

## Sample & Reference Applications

[**eShopOnContainers**](https://github.com/dotnet-architecture/eShopOnContainers) ⚠️ Archived (**Container-based microservices architecture**) (**MIT**) - is a sample reference application demonstrating various architecture patterns of container-based microservices by Microsoft.
...
[**practical-aspnetcore**](https://github.com/dodyg/practical-aspnetcore) ⭐ 10,406 | 🐛 177 | 🌐 C# | 📅 2026-09-03 (**Samples**) (**MIT**) - is a practical sample for ASP.NET Core.

[**EquinoxProject**](https://github.com/EduardoPires/EquinoxProject) ⭐ 6,778 | 🐛 6 | 🌐 C# | 📅 2026-04-14 (**Samples**) (**MIT**) - Full ASP.NET Core 3.1 application with DDD, CQRS and Event Sourcing concepts
...
[**sample-dotnet-core-cqrs-api**](https://github.com/kgrzybek/sample-dotnet-core-cqrs-api) ⭐ 3,060 | 🐛 13 | 🌐 C# | 📅 2024-02-27 (**Clean architecture**) (**MIT**) - Sample .NET Core REST API CQRS implementation with raw SQL and DDD using Clean Architecture.
...
[**clean-architecture**](https://github.com/jasontaylordev/CleanArchitecture) ⭐ 20,525 | 🐛 20 | 🌐 C# | 📅 2026-09-04 (**Clean architecture**) (**MIT**) - is a clean architecture template.
...
[**Dotnet-Boxed**](https://github.com/Dotnet-Boxed/Templates) ⭐ 3,487 | 🐛 51 | 🌐 C# | 📅 2026-09-04 (**Dotnet Boxed**) (**MIT**) - is a project template.
...
[**aspnetcore-realworld-example-app**](https://github.com/gothinkster/aspnetcore-realworld-example-app) ⭐ 2,087 | 🐛 5 | 🌐 C# | 📅 2026-09-02 (**CQRS, Fluent Validation, Automapper**) - is a example project demonstrating the use of CQRS, Fluent Validation, Automapper, and Entity framework core.
...
[**modular-monolith-with-ddd**](https://github.com/kgrzybek/modular-monolith-with-ddd) ⭐ 13,998 | 🐛 68 | 🌐 C# | 📅 2024-06-04 (**CQRS**)  (**MIT**) - Full Modular Monolith application with Domain-Driven Design approach.

[**EventSourcing.NetCore**](https://github.com/oskardudycz/EventSourcing.NetCore) ⭐ 3,681 | 🐛 24 | 🌐 C# | 📅 2026-05-18 (**Event Sourcing**) (**MIT**) - Example of Event Sourcing in .NET Core
...
[**Awesome collection of Libraries to build SaaS applications**](https://github.com/bharatdwarkani/awesome-libraries-to-build-sass-application-dotnet-core) ⭐ 296 | 🐛 1 | 📅 2024-03-03 -  Awesome collection of libraries to build Software as a Service (SaaS) application using ASP.NET Core
